        ...
        <div class="box-body">
            <div class="row">
                ...
                <div class="col-md-8 text-right">
                    <a href="{!! route('organizations.create') !!}" class="btn btn-info">
                        ...
                        @if(isset($data))
                            @foreach($data as $item)
                                <tr>
                                    ...
                                    <td class="text-center"><a href="{!! route('organizations.show',$item->id) !!}"
                                                               class="btn btn-success btn-xs"><i
                                                    class="fa fa-fw fa-edit"></i></a>&nbsp;
                                        <a onclick="return confirmDelete();return false;"
                                           href="{!! route('organizations.destroy',$item->id) !!}"
