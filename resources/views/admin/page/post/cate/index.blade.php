...
@section('content')
    <div class="box box-primary">
        <div class="box-body">
            <div class="row">
                <div class="col-md-4">
                    {!! Form::open(['route' => 'post.cate.store', 'method' => 'POST', 'id' => 'form-post', 'class' => '', 'autocomplete' => 'off']) !!}
                    {{ Form::text('post_type', $post_type, ['class'=>'form-control','id' => 'post_type', 'placeholder' => '']) }}
                ...
                <div class="col-md-8" style="margin-top: 20px">
                    <table class="table table-bordered" id="dataTable">
                        ...
                        @if(isset($data))
                            <tbody>
                            {!! admin_post_categories(0,'', $post_type) !!}
                            </tbody>
                        @endif
                    </table>
                </div>
