...
@section('content')
    <div class="box box-primary">
        <div class="box-body">
            {!! Form::open(['route' => 'slider.update', 'method' => 'POST', 'id' => 'form-post', 'class' => '', 'autocomplete' => 'off']) !!}
                ...
                <div class="col-md-3">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="type">
                            <option value="pc">PC (1500x500)</option>
                            <option value="mobile" @if ($data->type == 'mobile') selected @endif>Mobile (660x570)</option>
                        </select>
                    </div>
                    <div class="form-group">
