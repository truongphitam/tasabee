...
@section('content')
    <div class="box box-primary">
        <div class="box-body">
            {!! Form::open(['route' => 'post.update', 'method' => 'POST', 'id' => 'form-post', 'class' => '', 'autocomplete' => 'off']) !!}
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <div class="{!! hidden_categories_by_type($type) !!} form-group">
                        <label>{!! trans('admin.field.categories') !!}</label>
                        <select class="form-control" name="categories_id">
                            {!! showCategories($data->categories_id) !!}
                        </select>
                    </div>
                    <div class="form-group">
