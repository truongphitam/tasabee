				...
				<div class="row">
					<div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" required="" size="2" value="{!! $user->name !!}">
                        </div>
                        <div class="form-group">
                            <label>Email</label>
                            <input type="email" value="{!! $user->email !!}" disabled name="email" class="form-control" id="email" onkeyup="checkEmail();" required="">
                        </div>
                        ...
                        <div class="form-group">
                            <label>Website</label>
                            <input type="text" value="{!! $user->website !!}" name="website" class="form-control" size="2">
                        </div>
                        <div class="form-group">
                            <label>Số điện thoại</label>
                            <input type="text" value="{!! $user->phone !!}" name="phone" class="form-control" size="2">
                        </div>
                        <div class="form-group">
                            <label>Địa chỉ</label>
